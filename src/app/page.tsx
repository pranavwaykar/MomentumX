      ...
      <section className="flex-1 flex flex-col justify-center items-center text-center px-4 py-20 bg-gradient-to-b from-background to-muted/50">
        <div className="container max-w-4xl space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            A problem-first collaboration platform where entrepreneurs,
            developers, and designers form committed teams to build real-world
            solutions.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            ...
            <Button
              ...
              asChild>
              <Link href="/discovery">Explore Problems</Link>
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We enforce structure to ensure ideas turn into action. No more
              endless brainstorming without execution.
            </p>
          </div>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Submit a real-world problem using our structured stepper.
                  Define the domain, requirements, and vision.
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Define roles and attract talent. The project only starts when
                  the minimum team size is met.
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Track progress from Draft to MVP using our lifecycle tools.
                  Focus on shipping, not just talking.
                </p>
              </CardContent>
            </Card>
          </div>
